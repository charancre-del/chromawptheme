document.addEventListener('DOMContentLoaded', function () {
  ...
  (function curriculumChartInit() {
    ...
    const dataConfig = {
      ...
      toddler: {
        ...
        desc:
          'Toddlers explore movement, language, early problem-solving, and social skills through guided play and routines.',
        color: '#0d9488'
      },
      preschool: {
        data: [75, 65, 70, 55, 80],
        ...
        desc:
          'Preschoolers work on early literacy, math concepts, dramatic play, and collaborative projects, supported by strong routines.',
        color: '#ca8a04'
      },
      prep: {
        data: [65, 60, 75, 75, 70],
        ...
        desc:
          'Children build stamina for small-group work, early writing, and multi-step directions while strengthening self-regulation.',
        color: '#7c3aed'
      },
      prek: {
        data: [60, 60, 80, 90, 70],
        ...
        desc:
          'Aligned with GA standards, GA Pre-K balances phonemic awareness, pre-writing, and math with social-emotional learning and play.',
        color: '#0d9488'
      },
      afterschool: {
        data: [50, 70, 85, 75, 80],
        ...
        desc:
          'School-age programming offers homework help, social clubs, athletic play, and creative enrichment for older children.',
        color: '#ea580c'
      }
    };
  ...
  (function scheduleInit() {
    ...
    window.setScheduleAge = function (age) {
      ...
      // Update active age button styles
      ageKeys.forEach((key) => {
